...
import com.kauansantos.netflixclone.databinding.ActivityFormCadastroBinding
...
class FormCadastro : AppCompatActivity() {
    ...
    private fun CadastrarUsuario() {
        ...
        //Fazendo autenticação no firebase
